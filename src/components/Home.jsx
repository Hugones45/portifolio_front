    ...
    return (
        ...
        <div name="home" className="w-full h-screen bg-[rgb(10,25,47)] dark:bg-[#fff] flex justify-center">
            <div className="relative left-10  max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                ...
                <h2 className="text-4xl sm:text-7xl font-bold text-[#8892b0] dark:text-[#779feb]">I'm a Front End
                    Developer.</h2>
            ...
            <div className="relative right-20 justify-center items-center hidden xl:flex">
